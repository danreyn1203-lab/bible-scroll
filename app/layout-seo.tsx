...
export const metadata: Metadata = {
  title: "Taste Manna — AI-Powered Bible Discovery & Verses",
  description:
  ...
  openGraph: {
    title: "Taste Manna — Discover Scripture Daily",
